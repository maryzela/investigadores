...
$_paterno =$_POST['txt-paterno'];
$_materno =$_POST['txt-materno'];

 if($conexion->query ("INSERT INTO estudiante SET nombres='{$nombre}', paterno='{$paterno}', materno='{$materno}'")){
 	header("Location:estudiante.nuevo.formulario.php");//No existe el archivo
...
$fecha_registro =$_POST['txt-fecha_registro'];
